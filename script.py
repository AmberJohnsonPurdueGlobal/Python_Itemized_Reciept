...
a_float = .088
sales_tax = a_float
#Customer reciept with no items 
customer_one_total = 0
customer_one_itemization = ""
#Customer adds one item to reciept
customer_one_total += lovely_loveseat_price
customer_one_itemization += lovely_loveseat_name
#Customer adds second item to reciept
customer_one_total += luxurious_lamp_price
customer_one_itemization += luxurious_lamp_name
#Customer checks out reciept and tax is added to total
customer_one_tax = customer_one_total * sales_tax
#Visual display of reciept for customer to see items and total price
